...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private String[] mTestImages = {"snack1.jpg", "snack2.png", "snack3.jpg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("snacklist.txt")));
            String line;
